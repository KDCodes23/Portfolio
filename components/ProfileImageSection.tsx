...
export function ProfileImageSection() {
  return (
    <section
      id="portrait"
      className="scroll-mt-32 border-t border-white/12 py-18 sm:py-22 lg:py-24"
    >
        ...
        <div className="grid gap-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-stretch xl:gap-8">
          <Reveal delay={0.08} className="order-1">
            <article className="relative h-[540px] overflow-hidden border border-white/12 bg-panel shadow-panel sm:h-[620px] lg:h-[720px] xl:h-[760px] 2xl:h-[820px]">
              ...
              <div className="pointer-events-none absolute inset-x-0 top-0 z-30 flex items-center justify-between border-b border-white/12 bg-bg/65 px-4 py-2.5 backdrop-blur">
                ...
                <p className="text-[10px] uppercase tracking-[0.18em] text-accentBright">
                  Identity / KD-01
                </p>
              </div>
              ...
              {/* Main portrait */}
              <div className="absolute inset-0 z-20 flex items-end justify-center overflow-hidden px-3 pt-14 sm:px-4 sm:pt-16 lg:px-6 lg:pt-20">
                <div className="relative h-full w-full max-w-[420px] sm:max-w-[500px] lg:max-w-[560px] xl:max-w-[600px]">
                  <Image
              ...
              <div className="pointer-events-none absolute bottom-4 right-4 z-30 border border-accent/40 bg-accent/10 px-2.5 py-1.5">
                <p className="text-[10px] uppercase tracking-[0.18em] text-text">
                  Frontend + Founder
                </p>
              </div>
            </article>
          ...
          <Reveal className="order-2">
            <article className="h-full border border-white/12 bg-surface/85 p-6 shadow-panel sm:p-8 lg:p-9">
              <p className="text-[11px] uppercase tracking-[0.2em] text-accentBright">
                Founder Profile
              </p>
              ...
              <p className="mt-5 max-w-xl text-sm leading-relaxed text-muted sm:text-[15px]">
                This panel will feature a small video with my work and a brief
                description of my background, skills, and approach to frontend
                development and product design. The focus will be on showcasing
                my ability to create polished, user-centric interfaces that blend
                technical precision with strong visual identity.
              </p>
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-2">
                ...
                <div className="border border-white/12 bg-bg/70 p-4 sm:col-span-2">
                  ...
                  <p className="mt-1.5 text-sm text-text">
                    Founder of Vertex Studios, focused on polished interfaces and
                    ambitious collaborative builds.
                  </p>
                </div>
              </div>
            </article>
